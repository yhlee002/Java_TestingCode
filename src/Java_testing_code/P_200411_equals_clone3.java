...
public class P_200411_equals_clone3 {
	public static void main(String[] args) throws CloneNotSupportedException {
		...
		*/
		...
		od.strD = "Bye";
		od.ArrD = new int[]{100, 200, 300, 400, 500};
		/*
		od.ArrD = new int[4];
		...
		System.out.println(Arrays.toString(od.ArrD)); //[500, 200, 300, 400, 500]
		System.out.println(Arrays.toString(copyOd.ArrD)); //[100, 200, 300, 400, 500]
